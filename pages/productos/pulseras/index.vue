<template>
  <div>
    <div class="background">
      ...
      >
        <br />
        <h1 style="color: white">Pulseras</h1>
        <br />
      </div>
    </div>
...
useHead({
  ...
  link: [
    {
      rel: "canonical",
      href: "https://qillari.vercel.app/productos/pulseras",
    },
  ],
});
</script>
      ...
      productos: [
        {
          ...
          srcset:
            "/productos-webp/pulseras/regulable-arbol-de-la-vida-cel/ima1.webp 500w, /productos-webp/pulseras/regulable-arbol-de-la-vida/ima1.webp 1000w",
