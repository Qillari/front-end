<template>
  <div>
    <div class="background">
      ...
      >
        <br />
        <h1 style="color: white">Collares</h1>
        <br />
      </div>
    </div>
...
useHead({
  ...
  link: [
    {
      rel: "canonical",
      href: "https://qillari.vercel.app/productos/collares",
    },
  ],
});
</script>
